//===- mm_w4i32.cc - W4A8 GEMM, int32 C accumulate for AIE2P (svdq_gemm v1) -------===//
//
    ...
    chess_prepare_for_pipelining chess_loop_range(4, ) {
      ...
      for (unsigned j = 0; j < colB; j += 2)
...
#endif
        {
          ...
          aie::vector<int32, MMUL::size_C> acc_C00 =
              aie::load_v<MMUL::size_C>(pC1);
          aie::vector<int32, MMUL::size_C> acc_C01 =
              aie::load_v<MMUL::size_C>(pC1 + MMUL::size_C);
          aie::vector<int32, MMUL::size_C> acc_C10 =
              aie::load_v<MMUL::size_C>(pC2);
          aie::vector<int32, MMUL::size_C> acc_C11 =
...
void matmul_w4i32(const int8 *a_in, const int8 *b_packed_in, int32 *c_out) {
